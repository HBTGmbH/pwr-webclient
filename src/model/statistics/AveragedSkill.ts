...
export class AveragedSkill {
    ...
    @doop public get numberOfOccurrences() {return doop<number, this>()};
    @doop public get averageSkillLevel() {return doop<number, this>()};
    @doop public get relativeOccurrences() {return doop<number, this>()};
