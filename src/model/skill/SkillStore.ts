...
export class SkillStore {
     ...
     */
    @doop
    public get skillTreeRoot() {
        return doop<SkillTreeNode, this>();
    };
     ...
     */
    @doop
    public get categoriesById() {
        return doop<Immutable.Map<number, SkillCategory>, this>();
    };
     ...
     */
    @doop
    public get skillsById() {
        return doop<Immutable.Map<number, SkillServiceSkill>, this>();
    };
     ...
     */
    @doop
    public get skillsByQualifier() {
        return doop<Immutable.Map<string, SkillServiceSkill>, this>();
    };
     ...
     */
    @doop
    public get categorieHierarchiesBySkillName() {
        return doop<Immutable.Map<string, string>, this>();
    };
     ...
     */
    @doop
    public get parentCategoryIdById() {
        return doop<Map<number, number>, this>();
    };

    // == The following refer to the create skill dialog == //

    @doop
    public get currentAddSkillStep() {
        return doop<AddSkillStep, this>();
    };
     ...
     */
    @doop
    public get currentSkillName() {
        return doop<string, this>();
    }

    @doop
    public get currentChoice() {
        return doop<UnCategorizedSkillChoice, this>();
    };

    @doop
    public get skillComment() {
        return doop<string, this>();
    };
     ...
     */
    @doop
    public get noCategoryReason() {
        return doop<string, this>();
    };

    @doop
    public get doneState() {
        return doop<string, this>();
    };
     ...
     */
    @doop
    public get addToProjectId() {
        return doop<string, this>();
    };

    @doop
    public get filterNonCustomSkills() {
