...
const POWER_API_SUFFIX_PROFILE = "/power/api/pwr-profile-service/api";
...
const POWER_API_SUFFIX_STATISTICS = "/power/api/pwr-statistics-service";

const POWER_API_HOST_SKILL = "https://power.hbt.de";
const POWER_API_PORT_SKILL = "";
const POWER_API_SUFFIX_SKILL = "/power/api/pwr-skill-service";

const POWER_API_HOST_VIEW = "https://power.hbt.de";
const POWER_API_PORT_VIEW = "";
const POWER_API_SUFFIX_VIEW = "/power/api/pwr-view-profile-service";
